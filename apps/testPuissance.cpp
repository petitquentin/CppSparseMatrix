...
int main(int argc, char** argv){
    //int size = 17281;
    string file = "data/sgm2s1000000c.mtx";
    int size = 1000000;
    double start;
    int my_rank, p;
    double * result = NULL;
    ...
    puissance(&myMatrix2, X, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
    ...
    puissance(&myMatrix3, X, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix, X, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix2, Xf, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix3, Xf, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix, Xf, size, &result);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix2f, Xf, size, &resultFloat);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrix3f, Xf, size, &resultFloat);
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
    ...
    puissance(&myMatrixf, Xf, size, &resultFloat); 
    MPI_Barrier(MPI_COMM_WORLD);
    if(my_rank == 0){
        cout << "TEMPS : " <<  my_gettimeofday() - start << " s" << endl;
    }
